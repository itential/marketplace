...
Thank you for your interest in contributing to the marketplace project! This document provides guidelines and instructions for contributing to this project.
...
2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/marketplace.git
   ```
...
Thank you for contributing to marketplace!
