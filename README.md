...
[![Build Status](https://github.com/itential/marketplace/actions/workflows/ci.yml/badge.svg)](https://github.com/itential/marketplace/actions/workflows/ci.yml)
[![License](https://img.shields.io/badge/License-GPL--3.0-blue.svg)](LICENSE)
[![GitHub release](https://img.shields.io/github/v/release/itential/marketplace)](https://github.com/itential/marketplace/releases)
-->
...
A brief description of what marketplace does and why it exists.
...
# npm install -g marketplace
# brew install itential/tap/marketplace
# go install github.com/itential/marketplace@latest
```

### From Source

```bash
git clone https://github.com/itential/marketplace.git
cd marketplace
...
```bash
# Configure a device
marketplace configure --target router1.example.com --config network.yaml
...
- **Bug Reports**: [Open an issue](https://github.com/itential/marketplace/issues/new)
- **Questions**: [Start a discussion](https://github.com/itential/marketplace/discussions)
